...
$panel = array(
	'inbox'				=> array('src' => APPFOLDER.'/views/'.$current_skin.'/_global/images/panel-mail.png'),
	'inbox_unread'		=> array('src' => APPFOLDER.'/views/'.$current_skin.'/_global/images/panel-mail-unread.png'),
	'writing'			=> array('src' => APPFOLDER.'/views/'.$current_skin.'/_global/images/panel-writing.png'),
	'writing_unread'	=> array('src' => APPFOLDER.'/views/'.$current_skin.'/_global/images/panel-writing-unread.png'),
	'writing_read'		=> array('src' => APPFOLDER.'/views/'.$current_skin.'/_global/images/panel-writing-read.png'),
	'dashboard'			=> array('src' => APPFOLDER.'/views/'.$current_skin.'/_global/images/panel-dashboard.png'),
);
	...
	<div id="wrap">
			...
			<div id="menu">
				<div class="wrapper">
					...
					<div class="logged-in-controls">
						<?php if (Auth::is_logged_in()): ?>
                        	<?php if (panel_inbox_count() > 0)
							{
								echo panel_inbox(false, true, false, '(x)', img($panel['inbox_unread']));
							} else {
								echo panel_inbox(false, true, false, '(x)', img($panel['inbox']));
                            } ?>
                            <?php if (panel_writing_count() == 1) {
								echo panel_writing(false, true, false, '(x)', img($panel['writing_read']));
							} elseif (panel_writing_count() == 2) {
								echo panel_writing(false, true, false, '(x)', img($panel['writing_unread']));
							} elseif (panel_writing_count() == 0) {
								echo panel_writing(false, true, false, '(x)', img($panel['writing']));
							} ?>
		...
		<div class="wrapper">
			<div id="body">
				<div class="nav-sub">
            	<!-- INFO BOX -->
                <div class="infobox fontTiny">
	                <?php include_once(APPFOLDER . '/views/' . $current_skin . '/_global/pages/infobox.php'); ?>
                </div>
					<?php echo $nav_sub;?>
				</div>
